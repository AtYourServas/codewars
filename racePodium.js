...
function racePodium(blocks) {
    let result = [];
    if (blocks % 3 == 2) {
      return [(blocks -2) / 3 + 1, (blocks - 2) / 3 + 2, (blocks -2) / 3 - 1]
    }
    else if (blocks % 3 == 1 && blocks > 7) {
      return [(blocks - 1) / 3 + 1, (blocks - 1) / 3 + 2, (blocks - 1) / 3 - 2]
    }
    else if (blocks % 3 == 1 && blocks <= 7) {
      return [(blocks - 1) / 3, (blocks - 1) / 3 + 2, (blocks - 1) / 3 - 1]
    }
    else {
