...
function findDifference(a, b) {
    //use reduce to find volume of each cube, subtract difference, use absolute value for positive result
    return Math.abs(a.reduce( (curr, accum) => curr * accum) - b.reduce( (curr, accum) => curr * accum))
  }